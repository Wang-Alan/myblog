...
export default hopeTheme({
  hostname: "https://wang-alan.github.io/",
  ...
  blog: {
    medias: {
      Email: "mailto:wang-haolan@outlook.com",
      Gitee: "https://gitee.com/wang_haolan",
      GitHub: "https://github.com/Wang-Alan",
    },
  },
  ...
  locales: {
    "/en/": {
      ...
      footer: "Welcome to your visit",

      displayFooter: true,

      blog: {
        description: "A Ph.D Student",
        intro: "/about/",
      },
  ...
  encrypt: {
    config: {
      ...
      "/about/detail.html": ["T%a&9SB_dSLYmSZI8gZREl*5&RX_39Rcy)N&pjxf)L@p#mEPWQ"],
    },
  },
