...
<ul>
<li>You can place images besides your Markdown files, but you should use <strong>relative links</strong> (i.e.: starting with <code v-pre>./</code>) for them.</li>
<li>For images in <code v-pre>.vuepress/public</code> directory, please use absolute links (i.e.: starting with <code v-pre>/</code>) for them.</li>
</ul>
</div>
<p>The theme contains a custom badge:</p>
<blockquote>
<p>A dark blue badge text badge at the end of line. <code v-pre>&lt;Badge text=&quot;Badge text&quot; color=&quot;#242378&quot; /&gt;</code></p>
</blockquote>
